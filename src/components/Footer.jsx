...
const Footer = () => {
  ...
  const footerLinks = {
    services: [
      { name: 'Vidéos Immobilier', href: '#' },
      { name: 'Événements', href: '#' },
      { name: 'Vidéos Commerciales', href: '#' },
      { name: 'Inspections Techniques', href: '#' }
    ],
    company: [
      { name: 'À Propos', href: '#' },
  ...
  const socialLinks = [
    {
      ...
      icon: (
        <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24">
          <path d="M12.017 0C5.396 0 .029 5.367.029 11.987c0 6.62 5.367 11.987 11.988 11.987s11.987-5.367 11.987-11.987C24.004 5.367 18.637.001 12.017.001zM8.449 16.988c-1.297 0-2.448-.49-3.323-1.297C4.198 14.895 3.708 13.744 3.708 12.447s.49-2.448 1.418-3.323c.875-.807 2.026-1.297 3.323-1.297s2.448.49 3.323 1.297c.928.875 1.418 2.026 1.418 3.323s-.49 2.448-1.418 3.244c-.875.807-2.026 1.297-3.323 1.297zm7.83-9.606h-1.767V5.615h1.767v1.767zm-.807 5.065c0-.807-.318-1.53-.849-2.061s-1.254-.849-2.061-.849-1.53.318-2.061.849-.849 1.254-.849 2.061.318 1.53.849 2.061 1.254.849 2.061.849 1.53-.318 2.061-.849.849-1.254.849-2.061z" />
        </svg>
      )
    },
    {
        ...
        <div className="border-t border-gray-800 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
            <div className="text-sm text-gray-400">
              © {currentYear} DroneVision. Tous droits réservés.
            </div>
